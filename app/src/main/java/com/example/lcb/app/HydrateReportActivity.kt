...
import com.example.lcb.app.ui.hydrate.HydrateReportScreen
import com.example.lcb.app.ui.localizedContext
import com.example.lcb.app.ui.theme.LcbTheme

class HydrateReportActivity : FragmentActivity() {
    ...
    companion object {
        fun createIntent(context: Context): Intent {
            return Intent(context, HydrateReportActivity::class.java)
        }
    }
}
