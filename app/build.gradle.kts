...
fun resolveSigningFile(path: String): File {
    ...
    return if (rootRelativeFile.exists()) rootRelativeFile else file(path)
}
...
val googleReleaseAabName = "lcb_GoStep_release_$resolvedVersionName.aab"
...
dependencies {
    ...
    implementation("com.launcher.unity:com.leafmotivation.quizguessoncolor-gostep:1.0.7")
